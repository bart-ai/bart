...
% Cambiar por una foto de classif que diga "Label: Cartel" en vez de un numero
\begin{figure}[H]
\makebox[\textwidth][c]{
...
\makebox[\textwidth][c]{
    ...
    \qquad
    \subfloat{{\includegraphics[width=4cm]{./img/mobile.jpg} }}
}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
    \subfloat[\centering Un \textit{verdadero positivo} es el \textbf{acierto} donde se detecta un objeto correctamente]{{\includegraphics[width=0.4\textwidth]{./img/TP.jpg} }}
    \qquad
    \subfloat[\centering Un \textit{falso positivo} es un \textbf{error} donde se detecta un objeto no presente en la realidad]{{\includegraphics[width=0.4\textwidth]{./img/FP.jpg} }}
}
\end{figure}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
    \subfloat[\centering Un \textit{falso negativo} es un \textbf{error} donde no se detectó un objeto que sí esta presente]{{\includegraphics[width=0.4\textwidth]{./img/FN.jpg} }}
    \qquad
    \subfloat[\centering Un \textit{verdadero negativo} es un \textbf{acierto} donde no se detecta ningún objeto ya que realmente no hay ninguno presente]{{\includegraphics[width=0.4\textwidth]{./img/TP.jpg} }}
}
\end{figure}
